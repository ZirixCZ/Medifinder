        ...
        <View style={styles.container}>
            <Navbar navigation={navigation}>
                <View style={{display: "flex", justifyContent: "flex-start", alignItems: "center", width: "100%"}}>
                    <Image
                        style={{height: 58, width: 58, margin: "-5rem"}}
                ...
                <View style={styles.informationContainer}>
                    ...
                    <Text style={[styles.paragraph, {fontSize: 18}]}>
                        Devotyho 559, Pardubice 2<br />
                    </Text>
                    <Image
                        style={{height: 24, width: 120, margin: "0.75rem"}}
                ...
                >
                    <Image
                        style={[styles.timetable, {marginTop: "2rem"}]}
                        source={require("../../assets/Timetable.svg")}
                    />
                    <View style={{display: "flex", justifyContent: "flex-start", width: "100%"}}>
                        <Image
                            style={{marginTop: "0.75rem", marginLeft: "1.5rem", width: 176, height: 34}}
                            source={require("../../assets/PhoneNumber.svg")}
                        />
                        <Image
                            style={{marginTop: "0.75rem", marginLeft: "1.5rem", width: 206, height: 34}}
                        ...
                        <Text style={{fontSize: 16, color: "#666666", marginLeft: "2rem", marginTop: "0.5rem"}}>
                            Jsem praktická lékařka pro dospělé sídlící v poliklinice Devotyho. Aktuálně stále přijímám
                            nové pacienty.
                        </Text>
                        <View style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                            <Image
                                style={{marginTop: "0.75rem", width: 322, height: 127}}
                        ...
                        <View style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                            <Pressable onPress={() => navigation.navigate("hotdoctorsinyourarea")}>
                                <Image
                                    style={{marginTop: "0.75rem", width: 322, height: 127}}
                            ...
                            <Image
                                style={{marginTop: "0.75rem", width: 342, height: 145}}
                                source={require("../../assets/MHDTable.svg")}
                            />
                            <Image
                                style={{marginTop: "1rem", width: 182, height: 32}}
                                source={require("../../assets/NotificationOptions.svg")}
                            />
                            <Image
                                style={{marginTop: "0.75rem", marginBottom: "2rem", width: 90, height: 32}}
